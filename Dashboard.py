...
try:
    # الحل الشامل: اسم الملف + ترميز اللاتين + تخطي السطور البايظة
    ...
    # رسم بياني لأول 1000 نقطة لتسريع الأداء
    fig = px.scatter(df.head(1000), x='Wind Speed (m/s)', y=['LV ActivePower (kW)', 'Theoretical_Power_Curve (KWh)'])
